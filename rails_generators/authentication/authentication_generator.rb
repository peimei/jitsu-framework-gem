class AuthenticationGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    recorded_session = record do |m|
      ...
      m.template 'authentication_system.rb',
                  File.join('lib', 'authentication_system.rb')

      m.template 'authentication_test_helper.rb',
                  File.join('lib', 'authentication_test_helper.rb')
  ...
  protected
    ...
    def banner
      "Usage: #{$0} authentication ModelName [ControllerName]"
    end
